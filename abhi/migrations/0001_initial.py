# Generated by Django 4.1.2 on 2023-02-22 11:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='em',
            fields=[
                ('ids', models.CharField(max_length=50, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='filturm',
            fields=[
                ('filturmid', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filturmid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='abhi.filturm')),
            ],
        ),
    ]
